                        ...
                        <div className='footer ' >
                            ...
                            <div className='col-md-12 col-sm-12 col-lg-12'>
                                <div className='row text-center py-4 text-light'>
                                    <h6>Copyright <i class="fa-regular fa-copyright"></i>   metta muse . All rights reserved</h6>
                                </div>
                            </div>
